...
// We record results at these sample sizes (powers of 10, roughly)
// Going higher than 10^7 would freeze the browser without web workers
const MILESTONES = [1, 10, 100, 1_000, 10_000, 100_000, 1_000_000, 5_000_000, 10_000_000];
...
export function useMonteCarloSimulation() {
  ...
  const runSimulation = useCallback(async () => {
    ...
    const maxPoints = MILESTONES[MILESTONES.length - 1] ?? 10_000_000;
